...
- [Checklist de Performance do Angular](#checklist-de-performance-do-angular)
  ...
  - [Performance de Rede](#performance-de-rede)
    - [Bundling (Empacotamento)](#bundling-empacotamento)
    ...
    - [Pré-Carregamento de Recursos](#pré-carregamento-de-recursos)
    - [Carregamento Tardio de Recursos (Lazy Load)](#carregamento-tardio-de-recursos-lazy-load)
    - [Não use Lazy-Load na rota padrão](#não-use-lazy-load-na-rota-padrão)
    - [Cache](#cache)
    - [Use uma Casca da Aplicação](#use-uma-casca-da-aplicação)
    - [Use Service Workers](#use-service-workers)
  - [Otimizações em tempode execução](#otimizações-em-tempode-execução)
    - [Use `enableProdMode`](#use-enableprodmode)
    - [Compilação Ahead-of-Time (AoT)](#compilação-ahead-of-time-aot)
    ...
    - [Detecção de Mudança](#detecção-de-mudança)
      ...
      - [Desacoplando o detector de mudança](#desacoplando-o-detector-de-mudança)
      - [Executar fora do Angular](#executar-fora-do-angular)
    ...
    - [Otimize as expressões de template (Template Expressions)](#otimize-as-expressões-de-template-template-expressions)
- [Conclusão](#conclusão)
